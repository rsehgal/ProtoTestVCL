...
template <class T> void ListDevice() {
  ...
  if (T().deviceType == "CL_DEVICE_TYPE_CPU") {
    std::cout << "============================================================="
                 "============" << std::endl;
    std::cout << "You are trying to run CUDA code on CPU...." << std::endl;
    std::cout << "Kindly change your device to GPU or compile the code with "
                 "OpenCL backend" << std::endl;
    std::cout << "============================================================="
                 "============" << std::endl;
  } else {
